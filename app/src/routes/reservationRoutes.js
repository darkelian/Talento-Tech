...
const { newReservation,
     ...
     updateReservation, 
     deleteReservation,
     getReservationsByTutorId,
     getReservationsByStudentId } = require("../controllers/reservationController")
...
router.route('/reservations/tutor/:id').get(getReservationsByTutorId);  
